    ...
    seeDetail(item) {
      this.$router.push({
        ...
        query: {
          ...
          url:'https:' + item.coupon_share_url, //向详情页传递url
        }
      });
    }
  }
