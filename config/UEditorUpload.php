...
//                'endpoint_internal' => env('ALI_OSS_ENDPOINT_INTERNAL','oss-cn-hangzhou-internal.aliyuncs.com'),//'<internal endpoint [OSS内网节点] 如：oss-cn-shenzhen-internal.aliyuncs.com>', // v2.0.4 新增配置属性，如果为空，则默认使用 endpoint 配置(由于内网上传有点小问题未解决，请大家暂时不要使用内网节点上传，正在与阿里技术沟通中)
    ...
    'upload' => [
        ...
        "imageUrlPrefix" => env("APP_URL","http://127.0.0.1"), /* 图片访问路径前缀 */
        ...
        "catcherUrlPrefix" => env("APP_URL","http://127.0.0.1"), /* 图片访问路径前缀 */
        ...
        "videoUrlPrefix" => env("APP_URL","http://127.0.0.1"), /* 视频访问路径前缀 */
        ...
        "fileUrlPrefix" => env("APP_URL","http://127.0.0.1"), /* 文件访问路径前缀 */
        ...
        "imageManagerUrlPrefix" => env("APP_URL","http://127.0.0.1"), /* 图片访问路径前缀 */
        ...
        "fileManagerUrlPrefix" =>env("APP_URL","http://127.0.0.1"), /* 文件访问路径前缀 */
