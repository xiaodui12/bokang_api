                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <div class="btn-group pull-right" style="margin-right: 5px">
                                <a href="javascript:void(0);" class="btn btn-sm btn-danger 5d4cbb3fac1c0-delete" title="删除">
                                    <i class="fa fa-trash"></i><span class="hidden-xs">  删除</span>
                                </a>
                            </div>
                            <div class="btn-group pull-right" style="margin-right: 5px">
                                <a href="http://127.0.0.1/admin/systems/20" class="btn btn-sm btn-primary" title="查看">
                                    <i class="fa fa-eye"></i><span class="hidden-xs"> 查看</span>
                                </a>
                            </div>
                            <div class="btn-group pull-right" style="margin-right: 5px">
                                <a href="http://127.0.0.1/admin/systems" class="btn btn-sm btn-default" title="列表"><i class="fa fa-list"></i><span class="hidden-xs">&nbsp;列表</span></a>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="http://127.0.0.1/admin/systems/20" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container="">
                        ...
                        <div class="box-footer">
                            ...
                            <input type="hidden" name="_token" value="3wevKoM5FYY44JeC4Rg6jDiWcFBSz9NuQWUgaJCa"><div class="col-md-2">
                            </div>
                        ...
                        <input type="hidden" name="_method" value="PUT" class="_method"><input type="hidden" name="_previous_" value="http://127.0.0.1/admin/systems" class="_previous_"><!-- /.box-footer -->
                    </form>
                </div>
